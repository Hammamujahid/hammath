...
export default function Authenticated({ user, header, children, course }) {
    ...
    if (user.role === "admin") {
        return (
            <div className="min-h-screen bg-gray-100">
                <aside
                    ...
                    aria-label="Sidebar"
                >
                    <div className="h-full px-3 py-4 overflow-y-auto bg-white light:bg-white-800">
                        ...
                        <ul className="space-y-2 font-medium mt-16">
                            <li>
                                <a
                                    ...
                                    className="flex items-center p-2 text-gray-500 rounded-lg dark:text-grey-400 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                >
                                    <svg
                ...
                {header && (
                    <header className="ml-72 mt-8 mr-8 bg-white shadow">
        ...
        return (
            <div className="ml- min-h-screen bg-gray-100">
                <aside
                    id="logo-sidebar"
                    className="shadow fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
                    aria-label="Sidebar"
                >
                    <div className="h-full px-3 py-4 overflow-y-auto bg-white light:bg-white-800">
                        <div className="flex items-center pl-2.5 mb-5">
                ...
                <nav className="sticky top-0 right-0 left-0 ml-64 bg-white border-b border-gray-100 shadow z-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between h-16">
                            <div className="hidden sm:flex sm:items-center ml-auto">
                                <div className="ml-3 relative">
